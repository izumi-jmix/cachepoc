package org.izumi.jmix.cachepoc.test_support;

import org.izumi.jmix.cachepoc.CachepocApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "org.izumi.jmix.cachepoc.screen")
@ContextConfiguration(classes = {CachepocApplication.class, UiTestAssistConfiguration.class})
